function [ sol_pos_1, sol_pos_2, sol_pos_3, sol_pos_4 ] = geo_one_speaker_one_sentence( th, speaker, sentence )
...
%% Position 1
file_name = strcat ('speaker-',num2str(speaker),'_*position-1_sentence-',num2str(sentence),'_*','.geo_results.txt');
...
%% Position 2
file_name = strcat ('speaker-',num2str(speaker),'_*position-2_sentence-',num2str(sentence),'_*','.geo_results.txt');
myFiles = dir(fullfile(myDir, file_name)); %gets all txt files in struct
num_files = size(myFiles, 1); % get number of files
...
%% Position 3
file_name = strcat ('speaker-',num2str(speaker),'_*position-3_sentence-',num2str(sentence),'_*','.geo_results.txt');
myFiles = dir(fullfile(myDir, file_name)); %gets all txt files in struct
num_files = size(myFiles, 1); % get number of files
...
%% Position 4
file_name = strcat ('speaker-',num2str(speaker),'_*position-4_sentence-',num2str(sentence),'_*','.geo_results.txt');
myFiles = dir(fullfile(myDir, file_name)); %gets all txt files in struct
num_files = size(myFiles, 1); % get number of files
