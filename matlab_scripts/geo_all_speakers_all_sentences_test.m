...
% 
% 
% myFilteredDirs = filter_dir_list( myDirs, 'seb', window ) ;
...
% end
myFiles = get_file_list( myFilteredDirs, [speaker], 1, [sentence], 'geo', 0 ) ;
...
myFiles = get_file_list( myFilteredDirs, [speaker], 2, [sentence], 'geo', 0 ) ;
...
myFiles = get_file_list( myFilteredDirs, [speaker], 3, [sentence], 'geo', 0 ) ;
...
myFiles = get_file_list( myFilteredDirs, [speaker], 4, [sentence], 'geo', 0 ) ;
